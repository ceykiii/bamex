                                ...
                                <form action="{{route("admin.user.edit.post")}}" method="post">
                                    ...
                                    <div class="dropdown no-arrow mb-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="email" name = "email" value="{{$user->email}}" class="form-control form-control-user"
                                                   id="exampleInputEmail" aria-describedby="emailHelp"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="password" name="password" class="form-control form-control-user"
                                                   id="exampleInputPassword" placeholder="Şifrenizi Kullanın">
                                        </div>

                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Tekrar Yeni Şifre</label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select multiple="multiple" id="permissions" width = "50%" class="form-control" name="permission[]">
                                                @foreach ($userPermission as $key => $permission)
                                                    <option value='{{$permission}}' selected>{{$key}}</option>
                                                @endforeach

                                                @foreach ($diffPermission  as $key => $permission)
                                    ...
                                    <input type="submit" value="Kullanıcıyı Düzenle" class="btn btn-primary">
                                </form>
                            </div>
                        </div>
